...
@configclass
class ForkliftToyotaGeoEdgeProgressTeacherCleanStrictPPORunnerCfg(
    ForkliftToyotaGeoEdgeProgressTeacherPPORunnerCfg
):
    """Shorter clean-strict teacher run; select best checkpoint by eval."""

    max_iterations = 600
    save_interval = 50
    run_name = "progress_teacher_clean_strict_pushfix_v1"
    experiment_name = "forklift_toyota_geoedge_progress_teacher_clean_strict"


@configclass
class ForkliftToyotaGeoEdgeProgressTeacherCleanStrictNoForwardGatePPORunnerCfg(
    ForkliftToyotaGeoEdgeProgressTeacherCleanStrictPPORunnerCfg
):
    """Single-factor v2 for clean-strict teacher: no insert-progress gate on forward reward."""

    max_iterations = 600
    save_interval = 50
    run_name = "progress_teacher_clean_strict_no_forward_gate_v2"
    experiment_name = "forklift_toyota_geoedge_progress_teacher_clean_strict_no_forward_gate"
