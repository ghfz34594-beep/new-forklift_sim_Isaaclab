...
class ForkliftPalletInsertLiftEnvCfg(DirectRLEnvCfg):
    ...
    camera_version: str = "legacy_60deg_p68_x120_y55_z150_far40"
    visual_isolation_strict_validate: bool = False
...
@configclass
class ToyotaDualCameraWide100NoRoomCfg:
    """Camera-version mixin for new RGB data rendered with the 2026-06-04 rig."""

    camera_version: str = "wide100_p40_x150_y75_z140_far8_noroom_20260604"
    ...
    visual_isolation_far_clip_env_spacing_ratio: float = 0.45
    visual_isolation_strict_validate: bool = True
    vision_room_enable: bool = False
    vision_room_ceiling_enable: bool = False
    vision_room_floor_enable: bool = False
    visual_envelope_termination_enable: bool = False
    visual_envelope_center_y_m: float = 0.80
    visual_envelope_tip_y_m: float = 0.90
    visual_envelope_yaw_deg: float = 18.0
    visual_envelope_insert_norm_max: float = 0.35
    visual_envelope_min_steps: int = 8
    visual_envelope_termination_penalty_weight: float = 60.0
...
class ForkliftPalletApproachToyotaDualCameraCleanViewEnvCfg(ForkliftPalletApproachToyotaDualCameraPushSafeEnvCfg):
    ...
    camera_version: str = "cleanview45_p55_x135_y75_z120_far8_room"
...
class ForkliftPalletApproachToyotaDualCameraRoom60EnvCfg(ForkliftPalletApproachToyotaDualCameraPushSafeEnvCfg):
    ...
    camera_version: str = "room60_p50_x175_y85_z180_far8_room"
    dual_camera_hfov_deg: float = 60.0
...
@configclass
class ForkliftPalletApproachToyotaGeoEdgeProgressTeacherCleanStrictEnvCfg(
    ForkliftPalletApproachToyotaGeoEdgeProgressTeacherEnvCfg
):
    """Clean-strict privileged teacher variant targeting push-no-insert failures."""

    progress_teacher_away_penalty_weight: float = 8.0
    progress_teacher_aligned_approach_progress_weight: float = 78.0
    progress_teacher_near_align_progress_weight: float = 8.0
    progress_teacher_commit_progress_weight: float = 205.0
    progress_teacher_insert_weight: float = 170.0
    progress_teacher_insert_potential_weight: float = 2.6
    progress_teacher_hold_weight: float = 48.0
    progress_teacher_action_l2: float = -0.018

    progress_teacher_commit_dist_m: float = 0.56
    progress_teacher_center_gate_m: float = 0.18
    progress_teacher_yaw_gate_deg: float = 8.0
    progress_teacher_commit_center_sigma_m: float = 0.155
    progress_teacher_commit_tip_sigma_m: float = 0.135
    progress_teacher_commit_yaw_sigma_deg: float = 8.5

    progress_teacher_forward_reward_requires_insert_progress: bool = True
    progress_teacher_forward_insert_progress_start_norm: float = 0.00015
    progress_teacher_forward_insert_progress_ramp_norm: float = 0.0020
    progress_teacher_close_noinsert_gate_enable: bool = True
    progress_teacher_close_noinsert_gate_dist_m: float = 0.74
    progress_teacher_close_noinsert_insert_start_norm: float = 0.030
    progress_teacher_close_noinsert_insert_ramp_norm: float = 0.10
    progress_teacher_close_noinsert_positive_floor: float = 0.04
    progress_teacher_close_noinsert_commit_floor: float = 0.18
    progress_teacher_close_noinsert_penalty_weight: float = 0.75

    progress_teacher_push_sigma_m: float = 0.055
    progress_teacher_clean_disp_m: float = 0.055
    progress_teacher_success_disp_m: float = 0.045
    progress_teacher_dirty_insert_penalty_weight: float = 28.0
    progress_teacher_dirty_insert_disp_m: float = 0.028
    progress_teacher_dirty_insert_min_norm: float = 0.14
    progress_teacher_dirty_insert_termination_disp_m: float = 0.060
    progress_teacher_dirty_insert_termination_min_norm: float = 0.28
    progress_teacher_dirty_insert_termination_penalty_weight: float = 130.0
    progress_teacher_push_sigma_start_m: float = 0.11
    progress_teacher_clean_disp_start_m: float = 0.10
    progress_teacher_success_disp_start_m: float = 0.085
    progress_teacher_dirty_insert_weight_start: float = 4.0
    progress_teacher_dirty_insert_disp_start_m: float = 0.050
    progress_teacher_push_penalty_start_weight: float = 2.4
    progress_teacher_push_penalty: float = 8.5
    ...
    progress_teacher_dirty_termination_start_m: float = 0.17
    preinsert_push_termination_m: float = 0.085
    preinsert_push_termination_penalty_weight: float = 150.0
    dirty_push_termination_m: float = 0.115
    dirty_push_termination_penalty_weight: float = 210.0

    progress_teacher_misaligned_forward_penalty_weight: float = 3.2
    progress_teacher_misaligned_forward_near_m: float = 0.88
    progress_teacher_misaligned_forward_center_m: float = 0.105
    progress_teacher_misaligned_forward_tip_m: float = 0.105
    progress_teacher_misaligned_forward_yaw_deg: float = 5.5
    progress_teacher_reverse_drive_penalty_enable: bool = True
    progress_teacher_reverse_drive_penalty_weight: float = 0.35
    progress_teacher_reverse_drive_penalty_min_dist_m: float = 0.10
    progress_teacher_reverse_drive_penalty_ramp_m: float = 0.55

    progress_teacher_steer_sign_reward_enable: bool = True
    progress_teacher_steer_sign_weight: float = 0.55
    progress_teacher_steer_wrong_sign_penalty_weight: float = 2.8
    ...
    progress_teacher_steer_sign_deadband: float = 0.030
    progress_teacher_steer_sign_ramp: float = 0.20
...
@configclass
class ForkliftPalletApproachToyotaGeoEdgeProgressTeacherCleanStrictNoForwardGateEnvCfg(
    ForkliftPalletApproachToyotaGeoEdgeProgressTeacherCleanStrictEnvCfg
):
    """Single-factor v2: keep clean-strict penalties, restore forward reward bootstrap."""
...
@configclass
class ForkliftPalletApproachToyotaProgressStudentWide100NoRoomEnvCfg(
    ToyotaDualCameraWide100NoRoomCfg,
    ForkliftPalletApproachToyotaProgressStudentCleanViewEnvCfg,
):
    """Progress-student task that must be trained/evaluated on freshly rendered Wide100 RGB."""
...
class ForkliftPalletApproachDirectVisualInsertionCleanViewV40DirectEnvCfg(
    ...
    dual_camera_width: int = 224
    dual_camera_height: int = 224
    camera_version: str = "legacy_60deg_p68_x120_y55_z150_far8_room"
    dual_camera_hfov_deg: float = 60.0
    dual_camera_near_clip_m: float = 0.1
    dual_camera_far_clip_m: float = 8.0
    dual_camera_left_pos_local: tuple[float, float, float] = (120.0, 55.0, 150.0)
...
@configclass
class ForkliftPalletApproachToyotaGeoEdgeProgressTeacherCollectWide100NoRoomEnvCfg(
    ToyotaDualCameraWide100NoRoomCfg,
    ForkliftPalletApproachToyotaGeoEdgeProgressTeacherCollectEnvCfg,
):
    """Teacher geometry obs plus freshly rendered Wide100 RGB collection."""
