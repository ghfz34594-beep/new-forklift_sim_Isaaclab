...
parser.add_argument("--cam_prim_path", type=str, default="/World/envs/env_0/Robot/body/Camera")
parser.add_argument("--num_envs", type=int, default=1)
parser.add_argument("--video_folder", type=str, default="play_camera")
...
# Override viewer config to use the robot's camera
env_cfg.viewer.cam_prim_path = args_cli.cam_prim_path
