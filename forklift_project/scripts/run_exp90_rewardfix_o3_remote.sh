...
RUN_NAME="${RUN_NAME:-exp9_0_no_reference_rewardfix_o3_seed${SEED}}"
DRY_RUN="${DRY_RUN:-0}"
...
CMD=(
  ...
  # --- O3 new: postinsert dense shaping with yaw ---
...
echo "Started Exp9.0 O3 postinsert_align with yaw experiment."
echo "log: $LOG"
