...
日期：`2026-04-02 17:40:59`

## 1. 运行设置

| Run | Log | Final iter |
| --- | --- | ---: |
| strict (`tip_entry=0.12`) | `20260402_seed43_solo_debug_train_exp9_0_tipgate_ab_seed43_solo_debug_strict_seed43_iter1.log` | `0/1` |
| relaxed (`tip_entry=0.175`) | `20260402_seed43_solo_debug_train_exp9_0_tipgate_ab_seed43_solo_debug_relaxed0175_seed43_iter1.log` | `0/1` |
...
| --- | ---: | ---: | ---: |
| `phase/frac_inserted` | 0.0000 | 0.0000 | 0.0000 |
...
| `err/center_lateral_inserted_mean` | 0.0000 | 0.0000 | 0.0000 |
| `err/tip_lateral_inserted_mean` | 0.0000 | 0.0000 | 0.0000 |
| `err/yaw_deg_inserted_mean` | 0.0000 | 0.0000 | 0.0000 |
