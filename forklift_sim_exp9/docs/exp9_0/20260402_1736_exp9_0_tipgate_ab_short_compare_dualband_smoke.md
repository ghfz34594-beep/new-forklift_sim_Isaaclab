...
日期：`2026-04-02 17:36:08`

## 1. 运行设置

| Run | Log | Final iter |
| --- | --- | ---: |
| strict (`tip_entry=0.12`) | `20260402_dualband_smoke_train_exp9_0_tipgate_ab_dualband_smoke_strict_seed42_iter1.log` | `0/1` |
| relaxed (`tip_entry=0.175`) | `20260402_dualband_smoke_train_exp9_0_tipgate_ab_dualband_smoke_relaxed0175_seed42_iter1.log` | `0/1` |
...
| `err/center_lateral_inserted_mean` | 0.8121 | 0.8300 | 0.0179 |
| `err/tip_lateral_inserted_mean` | 0.9593 | 1.0038 | 0.0445 |
| `err/yaw_deg_inserted_mean` | 14.2018 | 16.8396 | 2.6378 |
