...
日期：`2026-04-02 18:07:30`

## 1. 运行设置

| Run | Log | Final iter |
| --- | --- | ---: |
| strict (`tip_entry=0.12`) | `20260402_directcheck_seed42_train_exp9_0_tipgate_ab_directcheck_strict_seed42_iter1.log` | `0/1` |
| relaxed (`tip_entry=0.175`) | `20260402_directcheck_seed42_train_exp9_0_tipgate_ab_directcheck_relaxed0175_seed42_iter1.log` | `0/1` |
...
| `err/center_lateral_inserted_mean` | 0.8009 | 0.8187 | 0.0178 |
| `err/tip_lateral_inserted_mean` | 0.9409 | 0.9750 | 0.0341 |
| `err/yaw_deg_inserted_mean` | 13.4892 | 15.0998 | 1.6106 |
